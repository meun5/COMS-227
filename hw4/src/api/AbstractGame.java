...
/**
 * A partial implementation of the Game interface for Tetris-like falling shape
 * games. Subclasses must implement the method determinePositionsToCollapse().
 */
public abstract class AbstractGame implements Game {
	...
	/**
	 * The piece that is subject to motion during the step() method or via
	 * invocations of the shiftXXX(), transform(), or cycle() methods.
	 */
	...
	/**
	 * A grid whose positions may be occupied by the icons the current falling piece
	 * or icons that can no longer be moved. Unoccupied array cells are null.
	 */
	private Icon[][] grid;
	...
	/**
	 * Generator for new pieces. See the documentation for BasicGenerator as an
	 * example.
	 */
	private Generator generator;

	/**
	 * State variable indicating which icons are to be deleted when the status is
	...
	/**
	 * Deletes the icons at the indicated positions and shifts icons above them
	 * down. Only icons lying within a column above a deleted icon are shifted down.
	 * This method does not update the game state and should normally be called only
